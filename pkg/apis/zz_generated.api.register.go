...
var heliumApiGroup = builders.NewApiGroupBuilder(
	"helium.aipg.intel.com",
	"github.com/nervanasystems/nuas/pkg/apis/helium").
	WithUnVersionedApi(helium.ApiVersion).
	WithVersionedApis(
		heliumv1.ApiVersion,
	).
	WithRootScopedKinds()

func GetHeliumAPIBuilder() *builders.APIGroupBuilder {
	return heliumApiGroup
}
